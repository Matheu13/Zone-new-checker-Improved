...
| **SSRF Protection** | DNS/IP and redirect validation on all outbound routes |
| **Response Limits** | Bounded request, JSON, and image bodies |
...
- ✅ **Browser isolation headers** - framing, content sniffing, referrer, and browser capability restrictions
