...
export default function HomePage() {
  ...
  function handleXtreamUrlChange(value: string) {
    try {
      const parsed = parseXtreamFromUrlLine(value);
      setXtreamSingle({
        url: value,
      ...
      // Normal while typing a base URL or an incomplete playlist URL.
      ...
      <div className="brandHeader">
        <div className="brandBar">
          ...
          <div className="brandCopy">
            <strong>ZONE NEW</strong>
            <span>Stream credential workspace</span>
          </div>
          <div className="brandStatus"><span /> Local-first tools</div>
        </div>
      </div>
            ...
            {mode === "xtream" && runMode === "single" && (
              <div className="row two">
                <div>
                  <label>URL</label>
                  <input
                    value={xtreamSingle.url}
                    onChange={(e) => handleXtreamUrlChange(e.target.value)}
                    placeholder="Paste server URL or full get.php M3U link"
                  />
      ...
      {canShowSingle && singleResult.ok ? (
        <div className="panel resultsPanel">
          <div className="resultsHeading">
            ...
            <span className="successPill"><span /> Active</span>
          </div>
